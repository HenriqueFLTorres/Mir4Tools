...
export default function MagicSquareShop() {
  return (
    <section className="mx-auto flex w-full max-w-[120rem] flex-col lg:gap-24 xl:gap-48 lg:justify-center gap-4 overflow-x-auto px-5 pb-14 pt-44 text-white md:p-14 md:pt-24 lg:flex-row">
