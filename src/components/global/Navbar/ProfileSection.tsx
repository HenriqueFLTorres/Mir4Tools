  ...
  return (
    <ProfileMenu>
      <button
        ...
        className="flex shrink-0 items-center gap-3 rounded-full border-2 border-transparent bg-black/20 p-1.5 pr-3 hover:border-white/10 motion-safe:transition-colors"
      >
        {image ? (
          <Image
            width={36}
