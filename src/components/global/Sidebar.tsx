  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          'absolute -right-12 rounded-md bg-black/20 p-2 hover:bg-black/40 motion-safe:transition-colors'
        )}
      >
        <Chevron
          className={cn(
  ...
  return !(session == null) || isLoading ? (
    <footer className="flex items-center gap-4">
      ...
      <button
        ...
        disabled={isLoading}
        className="ml-auto rounded-md bg-black/20 p-2 hover:bg-black/40 motion-safe:transition-colors"
      >
        <Exit />
      </button>
    </footer>
  ...
  return (
    <footer className="flex items-center gap-4">
      <button
        ...
        className="ml-auto w-full rounded-md bg-black/20 p-2 font-medium text-white hover:bg-black/40 motion-safe:transition-colors"
      >
        Log in with Google
      </button>
    </footer>
