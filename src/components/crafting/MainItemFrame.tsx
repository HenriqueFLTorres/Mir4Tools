        ...
        >
          <header className='flex justify-between gap-8'>
            ...
            <div className='flex gap-2.5'>
              <button
                onClick={() => setItemRarity('Legendary')}
                className={cn(
              ...
              />
              <button
                onClick={() => setItemRarity('Uncommon')}
                className={cn(
          ...
          {category === 'weapon' && (
            <div className='flex gap-2.5 text-sm font-medium text-white'>
              ...
              <MenuButton
                onClick={() => setWeaponType('secondary')}
                className={cn('py-2', {
