...
import BasicItemFrame from '../Inventory/BasicItemComponent';
...
export default function Inventory() {
  ...
  return (
    <section className='custom-scroll fixed left-0 top-0 flex h-screen w-screen flex-col overflow-y-auto bg-inventory-gradient p-14 backdrop-blur-xl'>
...
const nonRarity = ['copper', 'dark_steel', 'energy', 'glittering_powder'];
